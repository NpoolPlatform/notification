...
func init() {
	...
	_ = mailboxFields
	// mailboxDescContent is the schema descriptor for content field.
	mailboxDescContent := mailboxFields[6].Descriptor()
	// mailbox.ContentValidator is a validator for the "content" field. It is called by the builders before save.
	mailbox.ContentValidator = mailboxDescContent.Validators[0].(func(string) error)
